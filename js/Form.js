class Form{
    constructor(){
     ...
     this.hyg=createButton("Hygiene");
     this.envbutton=createButton("Environmental Development");
    ...
    display(){
        ...
        this.envbutton.position(width/2-75,250);
        this.phybutton.show();
        this.envbutton.show();
        this.prsbutton.show();
        ...
        this.envbutton.mousePressed(()=>{
            this.hide();
            this.hyg.position(width/2-20,100);
            this.hyg.show();
        });
